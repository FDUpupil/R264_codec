#ifndef __CABAC_INIT_TAB_H__
#define __CABAC_INIT_TAB_H__

const ContextModelSet::ContextModelInitPair ContextModelSet::ctxInitTable[CABAC_CONTEXT_MODELS_COUNT][4] = {
    { {  20, -15 } },
    { {   2,  54 } },
    { {   3,  74 } },
    { {  20, -15 } },
